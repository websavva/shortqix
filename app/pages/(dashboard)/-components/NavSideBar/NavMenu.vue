<template>
  <div :class="cn(props.class)">
    <!-- Desktop: Vertical layout with labels -->
    ...
    <!-- Mobile: Horizontal layout with icons only -->
    <div class="lg:hidden">
      <div class="flex space-x-1">
        <Button
          ...
          size="sm"
          as="NuxtLink"
          class="flex-1 flex-col h-auto p-2 group hover:bg-accent transition-all duration-200"
          :class="{
            'bg-accent text-primary': $route.path === to,
            'text-card-foreground': $route.path !== to,
          }"
        ...
        >
          <div
            class="p-1.5 rounded-md transition-colors duration-200 mb-1"
            :class="{
              'bg-primary/10 text-primary':
                $route.path === to,
              'bg-muted text-muted-foreground group-hover:bg-primary/10 group-hover:text-primary':
